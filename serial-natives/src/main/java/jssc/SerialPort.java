...
public class SerialPort {
     ...
     * @throws SerialPortException
     */
    public boolean setParams(SerialParams serialParams) throws SerialPortException {
        return setParams(serialParams, serialParams, serialParams, serialParams);
    }
     ...
     * @throws SerialPortException
     */
    public boolean setParams(BaudRate baudRate, DataBit dataBits, StopBit stopBits, Parity parity) throws SerialPortException {
        return setParams(baudRate.getBaudRate(), dataBits.getDataBits(), stopBits.getStopBits(), parity.getParity(),
                true, true);
    }
